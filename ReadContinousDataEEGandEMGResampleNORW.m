...
recorddates=strvcat('310714');%day month year
% recorddates=strvcat('220714');%day month year

mousenames=strvcat('Sherlock','Charles','Freud');
% mousenames=strvcat('Alan');
...
fsh24=fs*epochl*maxep;
pathoutMAT=[pathout,'output\'];mkdir(pathoutMAT)
...
for mouse=3
    ...
    for day=1:numdays
        ...
        for chan = 1:numch
            ...
            resampled_sig=filtfilt(b,a,resampled_sig);
        ...
        fnoutTXT=[tank,'-',mousename,'-EEG-EMG-',recorddate];
