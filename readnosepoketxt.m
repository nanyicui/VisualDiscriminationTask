function [time,behav] = readnosepoketxt(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [VARNAME1,EATING] = IMPORTFILE(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   [VARNAME1,EATING] = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data
%   from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [VarName1,Eating] = importfile('mouse1-CO-s1.txt',1, 70);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2013/08/13 12:39:34
